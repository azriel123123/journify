        ...
        <nav class="space-x-6 text-slate-700 font-medium">
            ...
            @auth
                ...
                <form action="{{ route('logout') }}" method="POST">
                    @csrf
                    <button
                        class="bg-orange-400 text-white font-semibold px-5 py-2 rounded-full hover:bg-orange-500 transition" type="submit">Logout</button>
                </form>
            </nav>
        @else
            <a href="{{ route('login') }}"><button
                    class="bg-orange-400 text-white font-semibold px-5 py-2 rounded-full hover:bg-orange-500 transition">Get
                    Started</button></a>
        @endauth
